...
use APP\plugins\generic\pln\controllers\grid\PLNStatusGridHandler;
use DOMDocument;
use DOMElement;
use Exception;
...
class PLNPlugin extends GenericPlugin
{
    ...
    public function setupComponentHandler(string $hookName, array $params): bool
    {
        ...
        PLNStatusGridHandler::setPlugin($this);
        return Hook::ABORT;
    }
     ...
     */
    public function getInstallMigration(): PLNPluginSchemaMigration
    {
    ...
    public function callbackLoadHandler(string $hookName, array $args): bool
    {
        ...
        define('HANDLER_CLASS', PLNHandler::class);
        $handlerFile = & $args[2];
